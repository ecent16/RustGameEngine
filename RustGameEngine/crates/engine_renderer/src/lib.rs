/*
    Description: Rendering and gpu settings script
*/
use std::sync::Arc;
use wgpu::*;
...
impl Renderer {
    ...
    pub async fn new(window: Arc<Window>) -> Self{
        ...
        Self{device, queue, surface, surface_config, win_size}
    }
    ...
    pub fn render(&self, pipeline: &wgpu::RenderPipeline) -> Result<(), wgpu::SurfaceError> {
